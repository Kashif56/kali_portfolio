...
const TopBar = () => {
  ...
  return (
    <div className="fixed top-0 right-0 px-3 py-1.5 bg-[#1a1a1a]/90 text-[#00ff41] font-mono text-xs flex items-center space-x-4 rounded-bl-md border-l border-b border-[#00ff41]/20 backdrop-blur-sm z-50 shadow-md">
      {/* Battery icon */}
